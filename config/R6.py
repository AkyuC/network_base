...
tn.write("router rip\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
tn.write("network 117.0.18.0/24\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
tn.write("network 117.0.11.0/24\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
tn.write("network 117.0.13.0/24\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
tn.write("network 154.0.6.0/24\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
...
tn.read_until("# ".encode('ascii'))
tn.write("network 117.0.18.0/24 area 0\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
tn.write("network 117.0.11.0/24 area 0\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
tn.write("network 117.0.13.0/24 area 0\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
tn.write("network 154.0.6.0/24 area 0\n".encode('ascii'))
tn.read_until("# ".encode('ascii'))
